...
public class CalculateDistanceTime {
    ...
    private String downloadUrl(String strUrl) throws IOException {
        ...
        try {
            ...
            Log.e("Exception dl url", e.toString());
        } finally {
            iStream.close();
    ...
    public interface taskCompleteListener {
        void taskCompleted(String[] time_distance, ArrayList<String> points);
    }
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
                ...
                for (int i = 0; i < result.size(); i++) {
                    ...
                    for (int j = 0; j < path.size(); j++) {
                        ...
                        if (j == 0) {    // Get distance from the list
                            ...
                            //int duration1 = Integer.parseInt(duration) * 2;
                            //duration = String.valueOf(duration1);
                            continue;
                        }


                        points.add(point.get("lat"));
                        points.add(point.get("lng"));
                        date_dist[0] = duration;
                        date_dist[1] = distance;
            ...
            mTaskListener.taskCompleted(date_dist, points);
        }
    }
}