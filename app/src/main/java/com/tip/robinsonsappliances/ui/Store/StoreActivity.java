...
public class StoreActivity
        extends MvpViewStateActivity<StoreView, StorePresenter>
        implements StoreView,  NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate( Bundle savedInstanceState ) {
        ...
        adapter = new StoreAdapter(getMvpView(), this);
    ...
    @Override
    public ViewState<StoreView> createViewState() {
